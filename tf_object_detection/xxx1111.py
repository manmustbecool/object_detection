...
from tf_object_detection.object_detection.utils import label_map_util
from tf_object_detection.object_detection.utils import visualization_utils as vis_util
            ...
            for i in range(int(num_detections[0])):
                if np.squeeze(scores)[i] > 0:
                    ...
                    if np_classes[i] in category_index.keys():
                        ...
                        class_name = 'N/A'
                    display_str = display_str + '  ' + str(class_name)
            print(display_str)
